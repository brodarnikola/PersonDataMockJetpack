 ...
 */
class AllPhonesRepositoryImpl  constructor(
    private val allPhones: AllPhonesDao,
    private  val dbMapper: DbMapper)
    : RoomDisplayAllPhonesRepository   {

    override fun getAllPhones(personId: Int): LiveData<List<AllPhones>> {
        return allPhones.getPhones(personId).map { dbMapper.mapDbAllPhonesToDomainPhones(it) }
    }
